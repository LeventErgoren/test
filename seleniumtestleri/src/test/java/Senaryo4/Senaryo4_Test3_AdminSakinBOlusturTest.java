...
public class Senaryo4_Test3_AdminSakinBOlusturTest {

    private WebDriver driver;
    private static final String BASE_URL = "http://localhost:1313";

    static final String RESIDENT_B_FIRST = "S4B";
    static final String RESIDENT_B_LAST = "PlateUnique";
    static final String RESIDENT_B_EMAIL = "s4b_plate@mail.com";
    static final String RESIDENT_B_PHONE = "05500000015";
    ...
    @Test
    void adminSakinBOlusturabilmeli() {
        adminLogin();
