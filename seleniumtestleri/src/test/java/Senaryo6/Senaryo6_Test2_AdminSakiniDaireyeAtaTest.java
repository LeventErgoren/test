...
public class Senaryo6_Test2_AdminSakiniDaireyeAtaTest {

    private WebDriver driver;
    private static final String BASE_URL = "http://localhost:1313";

    static final String RES_EMAIL = "s6_payment@mail.com";
    static final String RES_PHONE = "05500000017";
    ...
    @Test
    void adminSakiniOlusturupYeniDaireyeAtayabilmeli() {
        adminLogin();
