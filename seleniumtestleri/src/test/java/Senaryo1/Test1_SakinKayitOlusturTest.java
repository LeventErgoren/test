...
public class Test1_SakinKayitOlusturTest {

    private WebDriver driver;

    private static final String BASE_URL = "http://localhost:1313";

    // Bu değerler Test2-3-4'te de kullanılacak
    ...
    // Seeder'da erken gelen dolu bir daire: Kapı 2 (Manolya Apartmanı)
