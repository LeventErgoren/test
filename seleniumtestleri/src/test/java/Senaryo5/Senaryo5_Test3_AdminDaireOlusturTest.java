...
public class Senaryo5_Test3_AdminDaireOlusturTest {

    private WebDriver driver;
    private static final String BASE_URL = "http://localhost:1313";

    static final String DOOR_NUMBER = "505";
    ...
    @Test
    void adminDaireOlusturabilmeli() {
        adminLogin();
        ...
        new Select(selectByLabel("Blok")).selectByVisibleText(Senaryo5_Test1_AdminBlokOlusturTest.BLOCK_NAME);
        new Select(selectByLabel("Daire tipi")).selectByVisibleText(Senaryo5_Test2_AdminDaireTipiOlusturTest.FLAT_TYPE_NAME);
