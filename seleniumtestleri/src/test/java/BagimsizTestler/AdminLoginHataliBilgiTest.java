...
public class AdminLoginHataliBilgiTest {
    ...
    @Test
    void adminLoginHataliBilgilerleHataGosterilmeli() {
        ...
        passwordInput.clear();
        passwordInput.sendKeys("YANLIS_SIFRE");
        ...
        assertTrue(alertTitle.isDisplayed(), "Hata alert'i görünmeli");
    }
}
